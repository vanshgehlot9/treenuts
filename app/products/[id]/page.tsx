                    ...
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`h-4 w-4 ${
                            i < Math.floor(similarProduct.rating) ? "fill-amber-400 text-amber-400" : "text-gray-300"
                          }`}
                        />
                      ))}
                    </div>
                    <span className="text-sm text-muted-foreground">({similarProduct.reviewCount})</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="font-bold">₹{similarProduct.price}</span>
                    <Button size="sm" asChild>
                      <Link href={`/products/${similarProduct.id}`}>View</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
