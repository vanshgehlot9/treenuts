        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center min-h-[80vh]">
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-6 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-2xl ethnic-text-body">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-saffron-600 text-saffron-600 hover:bg-saffron-600 hover:text-white px-8 py-4 text-lg font-semibold transition-all duration-300 traditional-border-thin"
                asChild
              >
                <Link href="/products" className="flex items-center space-x-2">
          ...
          {/* Right Content - Replace Product Grid with Image */}
          <div className="relative flex justify-center items-center">
            <div className="relative w-full h-[500px] max-w-xl rounded-3xl overflow-hidden shadow-2xl border border-saffron-100 traditional-border bg-white/80">
                         <Image
